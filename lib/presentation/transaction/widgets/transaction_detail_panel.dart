...
/// Transaction detail panel for tablet layout - shows on the right side
class TransactionDetailPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _TransactionDetailPanelView(),
    );
  }
}

class _TransactionDetailPanelView extends StatelessWidget {
  const _TransactionDetailPanelView();
...
class TransactionDetailEmptyPanel extends StatelessWidget {
  const TransactionDetailEmptyPanel({super.key});
